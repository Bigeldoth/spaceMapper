...
///
/// Public parce que [`layouts`](crate::layouts) en a besoin lui aussi : sans
/// cela, chaque module rejouait la même paire de `#[cfg]`.
#[cfg(windows)]
pub fn enumerator() -> impl DeviceEnumerator {
